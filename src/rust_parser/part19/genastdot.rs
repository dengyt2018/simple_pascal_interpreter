...
pub mod gen_ast_dot {
    ...
    use crate::rust_parser::part19::spi19::pascal_parser::{ASTTree, Statements};
...
mod tests {
    ...
    use crate::rust_parser::part19::spi19::pascal_parser::{Lexer, Parser};

    use super::gen_ast_dot::*;

    const PATH: &str = "./src/rust_parser/part19/";

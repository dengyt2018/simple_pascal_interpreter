...
pub mod gen_ast_dot {
    ...
    use crate::rust_parser::part12::spi12::pascal_parser::{ASTTree, Statements};
...
mod tests {
    ...
    use crate::rust_parser::part12::spi12::pascal_parser::{Lexer, Parser};

    use super::gen_ast_dot::*;

    #[test]
    fn test_gen_ast_dot() {
        if let Ok(mut file) = File::open("./src/rust_parser/part12/part12.pas") {
            ...
            let path = "./src/rust_parser/part12/";

...
pub mod gen_ast_dot {
    ...
    use crate::rust_parser::part14::spi14::pascal_parser::{ASTTree, Statements};
...
mod tests {
    ...
    use crate::rust_parser::part14::spi14::pascal_parser::{Lexer, Parser};

    use super::gen_ast_dot::*;

    const PATH: &str = "./src/rust_parser/part14/";

    #[test]
    fn test_gen_ast_dot() {
        if let Ok(mut file) = File::open(format!("{}nestedscopes04.pas", PATH)) {

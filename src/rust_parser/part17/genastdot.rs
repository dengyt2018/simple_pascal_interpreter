...
pub mod gen_ast_dot {
    ...
    use crate::rust_parser::part17::spi17::pascal_parser::{ASTTree, Statements};
...
mod tests {
    ...
    use crate::rust_parser::part17::spi17::pascal_parser::{Lexer, Parser};

    use super::gen_ast_dot::*;

    const PATH: &str = "./src/rust_parser/part17/";

    #[test]
    fn test_gen_ast_dot() {
        if let Ok(mut file) = File::open(format!("{}part17.pas", PATH)) {

...
pub mod pascal_parser {
    ...
    impl Interpreter {
        ...
        fn visit(&mut self, node: ASTTree) -> Option<f64> {
            match node.stat {
        ...
        fn visit_program(&mut self, node: ASTTree) {
            if let Statements::Program { name, block } = node.stat {
        ...
        fn visit_binop(&mut self, node: ASTTree) -> f64 {
        ...
        fn visit_num(&mut self, node: ASTTree) -> f64 {
            node.stat
                .get_num()
                .parse::<f64>()
        ...
        fn visit_unary(&mut self, node: ASTTree) -> f64 {
        ...
        fn visit_var(&mut self, node: ASTTree) -> f64 {
